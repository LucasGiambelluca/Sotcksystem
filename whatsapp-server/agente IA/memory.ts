import type { AgentMemory, MemoryEntry, IntentType } from "./types";

const MAX_HISTORY = 20; // ventana de contexto
...
export class MemoryManager {
  ...
  /** Formatea el historial como string para inyectar al prompt */
