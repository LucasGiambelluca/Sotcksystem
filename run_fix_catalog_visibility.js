...
const migrationFile = path.join(__dirname, 'supabase', 'migrations', '20260410_fix_catalog_visibility.sql');
...
async function apply() {
  ...
  try {
    ...
    console.log('✅ Migración de visibilidad del catálogo exitosa');
